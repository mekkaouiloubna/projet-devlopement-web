        ...
        <form method="POST" action="{{ route('register') }}" class="auth-form" id="registerForm">
            ...
            <div class="form-group terms-group">
                <label class="checkbox-container">
                    ...
                    J'accepte les <a href="#terms-modal" data-modal="termsModal" style="text-decoration : none">conditions d'utilisation</a> et la <a href="#privacy-modal" style="text-decoration:none;" data-modal="privacyModal">politique de confidentialité</a>
                </label>
                @error('terms')
